<?php
	...
	$InsertCustomer_sig = array(array($xmlrpcStruct,$xmlrpcStruct),
					array($xmlrpcStruct,$xmlrpcStruct,$xmlrpcString,$xmlrpcString));
	...
	function  xmlrpc_InsertCustomer($xmlrpcmsg){
		...
		{
		 $rtn = new xmlrpcresp( php_xmlrpc_encode(InsertCustomer(php_xmlrpc_decode($xmlrpcmsg->getParam( 0 )),
			$xmlrpcmsg->getParam( 1 )->scalarval(  ),
				$xmlrpcmsg->getParam( 2 )->scalarval(  ))) );
		} else {
		 $rtn = new xmlrpcresp( php_xmlrpc_encode(InsertCustomer(php_xmlrpc_decode($xmlrpcmsg->getParam( 0 )), '', '')));
